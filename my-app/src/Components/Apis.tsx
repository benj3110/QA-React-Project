...
export async function GetFilms (props:string): Promise<FilmDataTypes[] | null> {
  ...
  try {
    ...
    const filmData: AxiosResponse<any, any> = await Axios.get(`https://api.themoviedb.org/3/movie/${popular}?api_key=${process.env.REACT_APP_TMDB_API_KEY}&language=en-US&page=1`)
